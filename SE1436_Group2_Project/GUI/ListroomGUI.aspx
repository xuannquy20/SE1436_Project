    ...
    <div class="bg-fb">
        <div class="div-feed">
            <asp:Panel ID="Panel1" runat="server" CssClass="box-fb">
                ...
                <asp:Button ID="Button1" runat="server" Text="Đặt phòng trực tiếp" Visible="False" Width="180px" CssClass="btn btn-success" BorderColor="#FF0066" BorderStyle="Solid" BorderWidth="1px" Font-Bold="True" Font-Size="Smaller" Height="33px" OnClick="Button1_Click"/>
                <br />
